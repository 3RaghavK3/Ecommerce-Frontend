...
export function PaymentConfirm() {
  ...
  const placeOrder = () => {
    ...
    localStorage.setItem(
      "CART",
      JSON.stringify({ items: [], totalq: 0, totalbill: 0 }),
    );
  ...
  return (
    <div className="h-screen bg-[#f3f3f3]/25 flex items-center justify-center p-4 text-center">
      <Card className="flex flex-col items-center shadow-2xl px-8 py-16 justify-around">
        {loading ? (
          <>
            ...
            <div>Hang tight! We're securely processing your payment</div>
          ...
          <>
            ...
            <div className="text-sm md:text-base">
              ...
              <span className="text-primary">{countdownTimer}</span> seconds...
            </div>
          </>
        )}
      </Card>
