    ...
    <>
      <div className="w-full h-[400px] flex items-center bg-[#F2F2FD] px-40">
        <div className="h-[70%]flex flex-col justify-between flex-1">
          ...
          <div className="text-5xl  leading-[1.15] gap-10">
          ...
          <div className="w-fit text-2xl p-1 px-3 rounded-sm text-white overflow-y-hidden bg-accent mt-4">Browse our collections below</div>
